 ...
 * 색깔은 JComboBox에서 선택
 * 둥근사각형의 구부러지는 각은 50,50으로 (모름하지말고)
 */
...
public class MsPaint extends JFrame {
	...
	private JRadioButton line, circle, rect, roundRect; // 사각형이 default
	...
	public MsPaint(String title) {
		//setLayout(null);
		x1L = new JLabel("x1"); y1L = new JLabel("y1");
		x2L = new JLabel("x2"); y2L = new JLabel("y2");
		z1L = new JLabel("z1"); z2L = new JLabel("z2");
		...
		//이벤트, 익명클래스 사용하자(버튼하나만 사용하니)
		draw.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				//this.repaint(); -ERROR. this는 MsPaint가 아니라 익명이너클래스
				can.repaint();
			}
		});
	}
