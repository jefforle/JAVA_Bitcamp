...
class ShapeTest{
	...
	//public void calcArea()//추상메소드: 상속시키니 모든 우선권이 자식에게 넘어감, 오버라이드된 부모클래스의 메소드는 이름만 필요하지 메모리에 잡을 필요 없으니 추상메소드가 필요
	public void calcArea() { 
		System.out.println("도형을 계산");
	}
	public void dispArea() {
		System.out.println("도형을 출력");
	}
}
//-------------------------
